...
| **الإصدار الحالي** | `v32` (ثابت `APP_VERSION` في أول app.js) |
...
- **v32:**
  1. **منع تكرار الطلاب وتأكيد النقل:** فحص مسبق للأسماء لمنع تكرار أو نقل أي طالب مسجل مسبقاً في الدرس المستهدف مع رسالة تأكيد تفصيلية توضح عدد الطلاب والأسماء المكررة المتخطاة قبل التنفيذ.
  2. **مراسلة جماعية مجمعة من عدة شهور ومصادر:** إمكانية تحديد وإرسال الرسائل لطلاب من الشهر الحالي وشهور مؤرشفة معاً في جلسة إرسال متتابع واحدة مع منع تكرار المراسلة للطالب المشترك تلقائياً وإظهار شارات المصدر.
  3. **ضبط وتجاوب جدول درجات الاختبارات على الموبايل:** إصلاح مشكلة كبر عمود اسم الطالب وثباته لتظهر خانات الدرجات والمتوسط بوضوح وسلاسة مع إمكانية التمرير الأفقي الحر والتجاوب مع شاشات الهواتف.
  4. **تخصيص واختيار الطلاب في المراسلة الجماعية:** إمكانية تحديد الطلاب يدوياً باختيار فردي أو أزرار سريعة (الحاضرون فقط، الغائبون فقط، تحديد الكل) مع البحث الفوري ودعم إرسال الرسائل للدروس الحالية والمؤرشفة.
- **v31:**
  1. **تخصيص تصدير تيليجرام:** إمكانية تحديد البيانات المراد إرسالها إلى محادثة تيليجرام (النسخة الكاملة، أو تحديد درس معين/دروس معينة عبر قائمة اختيار مستقلة) مع أسماء ملفات وكابشن مخصص لكل اختيار.
  2. **إرفاق الصور في المراسلة الجماعية المتتابعة:** إمكانية إرفاق صورة/بوستر مع الرسائل التسلسلية مع خيار المشاركة المباشرة (Web Share)، ونسخ الصورة تلقائياً للحافظة للصق الفوري (Ctrl+V) في شات واتساب.
  3. **حماية تصفير كلمة سر قسم الدخل والأمان:** حماية مشددة تشترط التواصل مع المطور (+20 12 83279337) وإدخال كود التفعيل المعتمد (967925868934670272500351) لتصفير كلمة المرور أو سؤال الأمان عند نسيانها.
- **v30:** 
  ...
  8. **إعادة الضبط والبدء من جديد (Reset):** تصفير كلمة سر الدخل والأمان دون مساس بالطلاب، أو تصفير درس محدد وتفريغ طلابه وسجلاته، أو استرجاع الإعدادات، أو تصفير شامل مع رسائل تأكيد.
