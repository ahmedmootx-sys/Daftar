...
| **الإصدار الحالي** | `v33` (ثابت `APP_VERSION` في أول app.js) |
...
- **v33:**
  1. **إصلاح وتجاوب التقرير الشامل على الهواتف:** ضبط أبعاد الأعمدة وثبات عمود اسم الطالب بدقة مع إمكانية التمرير الأفقي الحر لعرض كافة الشهور ونسب الحضور بوضوح.
  2. **تحسين بطاقات الطلاب في المراسلة الجماعية:** إعادة تصميم بطاقة الطالب في قائمة المراسلة المخصصة لتظهر الاسم والمجموعات والشارات ورقم الهاتف وحالة الحضور بتنسيق منظم يمنع التداخل والقص على الموبايل.
- **v32:**
